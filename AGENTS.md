...
This repository's authoritative project guidance lives in [`CLAUDE.md`](./CLAUDE.md).

All coding agents working in this repository must read and follow `CLAUDE.md` before
making changes. Treat it as the source of truth for:

- project purpose and deployment assumptions;
- visual/design doctrine and anti-patterns;
